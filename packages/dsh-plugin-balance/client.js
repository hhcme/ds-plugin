...
window.__ModuleLoader__.load({
  ...
  factory: function (require) {
    ...
    function SettingsAboutSection() {
      ...
      var infoLine = null;
      if (status === "updating") {
        infoLine = React.createElement("div", { style: { marginTop: "14px", color: T.brand, fontSize: "12px" } },
          "\u66f4\u65b0\u5df2\u542f\u52a8\uff1a\u670d\u52a1\u5373\u5c06\u91cd\u542f\uff0c\u7a0d\u540e\u5237\u65b0\u9875\u9762\u5373\u53ef\uff08\u65e5\u5fd7\uff1a~/.dsh/dsh-web-update.log\uff09");
      } else if (about != null && about.checkError != null) {
        infoLine = React.createElement("div", { style: { marginTop: "14px", color: T.error, fontSize: "11px" } }, "\u68c0\u67e5\u5931\u8d25\uff1a" + about.checkError);
      } else if (about != null && about.latest != null && !about.upToDate) {
        infoLine = React.createElement("div", { style: { marginTop: "14px", color: T.brand, fontSize: "11px" } },
          "\u53d1\u73b0\u65b0\u7248\u672c " + about.latest + (about.publishedAt != null ? " \u00b7 \u53d1\u5e03\u4e8e " + String(about.publishedAt).slice(0, 10) : ""));
      }
      // Checking never spawns its own line: the spinner lives inside the
      // fixed-width button, so the page neither flashes nor shifts layout.
      var checking = status === "checking";
      var buttons = status === "updating" ? null : React.createElement("div", { style: { display: "flex", gap: "8px", marginTop: infoLine != null ? "12px" : "20px", flexWrap: "wrap", justifyContent: "center" } },
        React.createElement("button", {
          type: "button",
          disabled: checking || busy,
          onClick: function () { setBusy(true); checkUpdate(true); setBusy(false); },
          style: { display: "inline-flex", alignItems: "center", justifyContent: "center", gap: "6px", minWidth: "104px", border: "1px solid rgba(255,255,255,0.10)", background: T.hoverBg, color: T.label, borderRadius: "8px", padding: "5px 12px", cursor: "pointer", fontSize: "12px", font: "inherit" },
        },
          checking ? React.createElement("span", { style: { width: "11px", height: "11px", borderRadius: "50%", border: "2px solid rgba(255,255,255,0.15)", borderTopColor: T.brand, display: "inline-block", animation: "tp-spin 0.8s linear infinite", flexShrink: 0 } }) : null,
          "\u68c0\u67e5\u66f4\u65b0",
        ),
