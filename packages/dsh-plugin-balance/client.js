    ...
    function SettingsAboutSection() {
      ...
      if (status === "checking") {
        ...
        statusLine = about.upToDate
          ? React.createElement("span", { style: { color: T.success, fontSize: "11px", display: "flex", alignItems: "center", gap: "5px" } }, "\u2713 \u5df2\u662f\u6700\u65b0\u7248\u672c")
      ...
      if (status === "updating") {
        ...
        actionArea = React.createElement("div", { style: { display: "flex", gap: "8px", marginTop: "12px", flexWrap: "wrap" } },
          React.createElement("button", {
            type: "button",
      ...
      return React.createElement("div", { style: pageWrapStyle },
        React.createElement("div", { style: Object.assign({}, cardStyle2, { marginTop: "12px", padding: "16px" }) },
          React.createElement("div", { style: { display: "flex", alignItems: "center", gap: "12px" } },
            React.createElement("div", { style: { width: "44px", height: "44px", borderRadius: "12px", background: "rgba(77,141,255,0.14)", border: "1px solid rgba(77,141,255,0.28)", display: "grid", placeItems: "center", color: T.brand, flexShrink: 0 } },
              React.createElement("svg", { viewBox: "0 0 50 50", width: 26, height: 26, fill: "currentColor", "aria-hidden": true },
            ...
            React.createElement("div", { style: { flex: "1", minWidth: 0 } },
              ...
              React.createElement("div", { style: { fontSize: "11px", color: T.tertiary, marginTop: "2px", fontVariantNumeric: "tabular-nums" } },
                "\u5f53\u524d\u7248\u672c " + (about != null && about.installed != null ? about.installed : "\u2014")),
            ),
          ),
          React.createElement("div", { style: { height: "1px", background: T.divider, margin: "14px 0 10px" } }),
          statusLine,
          actionArea,
        ),
      );
